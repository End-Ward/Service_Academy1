    ...
    public partial class SeedRolesAndUsers : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { adminUserId, "admin@academy.com", "ADMIN@ACADEMY.COM", "admin@academy.com", "ADMIN@ACADEMY.COM", true, hasher.HashPassword(null, "Admin123!"), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), null, false, false, null, false, 0, "Admin User" },
                    { instructorUserId1, "instructor1@academy.com", "INSTRUCTOR1@ACADEMY.COM", "instructor1@academy.com", "INSTRUCTOR1@ACADEMY.COM", true, hasher.HashPassword(null, "Instructor123!"), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), null, false, false, null, false, 0, "Instructor User 1" },
                    { instructorUserId2, "instructor2@academy.com", "INSTRUCTOR2@ACADEMY.COM", "instructor2@academy.com", "INSTRUCTOR2@ACADEMY.COM", true, hasher.HashPassword(null, "Instructor123!"), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), null, false, false, null, false, 0, "Instructor User 2" },
                    { instructorUserId3, "instructor3@academy.com", "INSTRUCTOR3@ACADEMY.COM", "instructor3@academy.com", "INSTRUCTOR3@ACADEMY.COM", true, hasher.HashPassword(null, "Instructor123!"), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), null, false, false, null, false, 0, "Instructor User 3" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "UserId", "RoleId" },
                keyValues: new object[] { instructorUserId1, instructorRoleId }
            );
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "UserId", "RoleId" },
                keyValues: new object[] { instructorUserId2, instructorRoleId }
            );
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "UserId", "RoleId" },
                keyValues: new object[] { instructorUserId3, instructorRoleId }
            );
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "UserId", "RoleId" },
